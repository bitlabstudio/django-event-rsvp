...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Guest.is_attending'
        db.add_column('event_rsvp_guest', 'is_attending',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Guest.message'
        db.add_column('event_rsvp_guest', 'message',
                      self.gf('django.db.models.fields.TextField')(default='', max_length=4000, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Guest.is_attending'
        db.delete_column('event_rsvp_guest', 'is_attending')

        # Deleting field 'Guest.message'
        db.delete_column('event_rsvp_guest', 'message')
    ...
    models = {
        ...
        'event_rsvp.event': {
            ...
            'end': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 6, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'start': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 5, 0, 0)'}),
