...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Event.hide_available_seats'
        db.add_column('event_rsvp_event', 'hide_available_seats',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Event.hide_available_seats'
        db.delete_column('event_rsvp_event', 'hide_available_seats')
