...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('event_rsvp_event', 'image',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='rsvp_event_images', null=True, to=orm['filer.Image']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Event.image'
        db.delete_column('event_rsvp_event', 'image_id')
    ...
    models = {
        ...
        'event_rsvp.event': {
            ...
            'end': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 20, 0, 0)'}),
            'hide_available_seats': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'rsvp_event_images'", 'null': 'True', 'to': "orm['filer.Image']"}),
            ...
            'start': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 19, 0, 0)'}),
