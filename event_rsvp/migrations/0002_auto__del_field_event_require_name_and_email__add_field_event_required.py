...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Event.require_name_and_email'
        db.delete_column('event_rsvp_event', 'require_name_and_email')

        # Adding field 'Event.required_fields'
        db.add_column('event_rsvp_event', 'required_fields',
                      self.gf('event_rsvp.models.MultiSelectField')(default='', max_length=250, blank=True),
                      keep_default=False)

        # Adding field 'Guest.phone'
        db.add_column('event_rsvp_guest', 'phone',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Event.require_name_and_email'
        db.add_column('event_rsvp_event', 'require_name_and_email',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Event.required_fields'
        db.delete_column('event_rsvp_event', 'required_fields')

        # Deleting field 'Guest.phone'
        db.delete_column('event_rsvp_guest', 'phone')
    ...
    models = {
        ...
        'event_rsvp.event': {
            ...
            'end': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 24, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'start': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 23, 0, 0)'}),
