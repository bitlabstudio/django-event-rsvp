...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('event_rsvp_event', 'title', self.gf('django.db.models.fields.CharField')(max_length=256))

    def backwards(self, orm):

        # Changing field 'Event.title'
        db.alter_column('event_rsvp_event', 'title', self.gf('django.db.models.fields.CharField')(max_length=50))
