...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('event_rsvp_event', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=256))

    def backwards(self, orm):

        # Changing field 'Event.slug'
        db.alter_column('event_rsvp_event', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=50))
    ...
    models = {
        ...
        'event_rsvp.event': {
            ...
            'end': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 13, 0, 0)'}),
            ...
            'start': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 12, 0, 0)'}),
